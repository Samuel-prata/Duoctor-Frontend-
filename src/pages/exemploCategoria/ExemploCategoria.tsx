        ...
        <>
            <Grid container className="info" md={12} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <Grid item xs={6} className='card-container'>
                    <Card variant="outlined" className='show-card-exemplo' id="medicamentos">
                    ...
                    <Card variant="outlined" className='show-card-exemplo' id="exames">
                        <CardContent className='card-conteudo'>
                            <div id="icon-exame">
                                <LocalHospitalIcon />
                            </div>
                    ...
                    <Card variant="outlined" className='show-card-exemplo' id="consultas">
